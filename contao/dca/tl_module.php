...
$GLOBALS['TL_DCA']['tl_module']['palettes'][\Mindbird\Contao\Company\Controller\CompanyListController::class] = '{title_legend},name,headline,type;{archiv_legend},company_archiv,company_category,jumpTo,company_random,company_filter_disabled,numberOfItems,perPage,imgSize,companyTpl;{template_legend},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes'][\Mindbird\Contao\Company\Controller\CompanyDetailController::class] = '{title_legend},name,headline,type;{image_legend},imgSize;{gallery_legend},gallery_size,gallery_imagemargin,gallery_perRow,gallery_perPage,gallery_numberOfItems,gallery_fullsize,gallery_template;{template_legend},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes'][\Mindbird\Contao\Company\Controller\CompanyFilterController::class] = '{title_legend},name,type;{archiv_legend},company_archiv,jumpTo;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes'][\Mindbird\Contao\Company\Controller\CompanyMapController::class] = '{title_legend},name,headline,type;{archiv_legend},company_archiv,company_category,jumpTo,company_random,company_filter_disabled;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
