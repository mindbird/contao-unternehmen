...
$GLOBALS['TL_DCA']['tl_module']['palettes']['company_filter'] = '{title_legend},name,type;{archiv_legend},company_archiv,jumpTo;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['company_map'] = '{title_legend},name,headline,type;{archiv_legend},company_archiv,company_category,jumpTo,company_random,company_filter_disabled;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
